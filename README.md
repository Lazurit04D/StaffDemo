...
### Приложение
Написать демонстрационное приложение для управления сведениями о сотрудниках компании.

Получаем штат сотрудников на основе данных из текстового файла и рассчитывает им зарплату, исходя из отработанного времени и участия в проектах.
Информация о сотрудниках, об отработанном времени и заработной плате выводится на экран в виде таблицы.

Приложение работает пока пользователь не введет нужную информацию для завершения его работы. При завершении работы, приложение должно обновить информацию в файле.

Приложение должно иметь следующий функционал:
- Вывод таблицы с информацией обо всех сотрудниках.
- Вывод сотрудников задействованых на определенном проекте, который введет пользователь
- Поиск сотрудников по:
  - должности
  - имени 
- Поиск сотрудников, которые зарабатывают больше/меньше суммы введеной пользователем.
- Создание нового проекта
- Добавление сотрудника(если для него это применимо) на проект
- Перевод сотрудника(если для него это применимо) на другой проект
- Сохранить текущее состояние данных в файл

Пример кусочка приложения
```cpp
